...
export default function BlogPage({ params }) {
  ...
  return (
    <>
        ...
        <link rel="canonical" href={`https://www.epicssolution.com/development/${slug}`} />
        ...
        <meta property="og:url" content={`https://www.epicssolution.com/development/${slug}`} />
            ...
            __html: `
              {
                ...
                "mainEntityOfPage": {
                  "@type": "WebPage",
                  "@id": "https://www.epicssolution.com/development/${slug}"
                }
              }
            `,
          }}
